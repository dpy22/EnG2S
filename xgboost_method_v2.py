...
def train_and_evaluate(
    ...
    # 记录超参数到报告生成器
    if report_gen is not None:
        report_gen.set_hyperparameters(params)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_depth", type=int, default=9, help="树的最大深度")
    parser.add_argument("--learning_rate", type=float, default=0.044913467579125975, help="学习率")
    parser.add_argument("--n_estimators", type=int, default=800, help="树的数量")
